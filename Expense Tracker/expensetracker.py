...
Label(window, text='Description',font=("Californian FB", 12, "bold"), bg='Light Gray').place(relx=0.078, rely=0.1)

description_entry = Entry(window, width=18, font=("Californian FB", 12))
description_entry.place(relx=0.03, rely=0.14)

Label(window, text='Category',font=("Californian FB", 12, "bold"), bg='Light Gray').place(relx=0.34, rely=0.1)

category_entry = Entry(window, width=18, font=("Californian FB", 12))
category_entry.place(relx=0.28, rely=0.14)

Label(window, text='Amount', font=("Californian FB", 12, "bold"), bg='Light Gray').place(relx=0.593, rely=0.1)

amount_entry = Entry(window, width=18, font=("Californian FB", 12))
amount_entry.place(relx=0.53, rely=0.14)

Label(window, text='Date(YYYY-MM-DD)',font=("Californian FB", 12, "bold"), bg='Light Gray').place(relx=0.79, rely=0.1)

date_entry = Entry(window, width=18, font=("Californian FB", 12))
date_entry.place(relx=0.78, rely=0.14)
...
listbox = Listbox(window, font=('Californian FB', 12), height=30, width=80)
...
listbox.place(relx=0.1, rely=0.245)

#creating a button to delete an expense

Button(window, text='Delete Expense', font=frame_font, width=89, command=delete_expense).place(relx=0.102 , rely=0.918)
